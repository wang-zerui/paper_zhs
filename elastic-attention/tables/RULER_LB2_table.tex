\begin{table*}[t]
\centering
\caption{Model performance on RULER~\citep{hsieh2024ruler} and LongBench-v2~\citep{bai2024longbench2}. We report the average Perf. and $\Omega_{\mathrm{{MSR}}}$.}
\small
\resizebox{\linewidth}{!}{
...
\cmidrule(lr){2-9} \cmidrule(lr){10-13}
 & \bf 8K &\bf 16K &\bf 32K &\bf 64K &\bf 128K &\bf 256K & \textbf{Perf.} & $\mathbf{\Omega_{\mathrm{\textbf{MSR}}}}$ &\bf Easy &\bf Hard & \textbf{Perf.} & $\mathbf{\Omega_{\mathrm{\textbf{MSR}}}}$ \\
