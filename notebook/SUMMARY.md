...
* [CHIME: A Case for Efficient Long-Context Attention-FC Disaggregated Inference with DIMM-PIM](papers/chime.md)
...
* [JIT-Agent: Scaling Harness Intelligence via Just-in-Time Harness Evolution](papers/jit-agent.md)
