...
async function main() {
  const out = path.join(__dirname, 'paper_talk_flexrl_iclr26_fixed.pptx');
...
pptx_path = Path(${JSON.stringify(path.join(__dirname, 'paper_talk_flexrl_iclr26_fixed.pptx'))})
