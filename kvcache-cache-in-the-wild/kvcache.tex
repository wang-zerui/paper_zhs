...
\newcommand{\figsuffix}{.png} %% .png or .pdf

%\newcommand{\sys}{{\textsc{DrTM+S}}} 
%\newcommand{\sys}{{\textsc{BlitzScale}}} %% anonymous version 
\newcommand{\sys}{{\textsc{KV\$$^2$}}} %% anonymous version 
...
\newcommand{\company}{\textsc{Aliyun}}
\newcommand{\companyfull}{\textsc{Aliyun Tongyi}}
...
\newcommand{\traceproduction}{T-production}
\newcommand{\tracelab}{T-lab}
...
% Customize the appearance of affiliations
...
\title{\Large \bf{KVCache Cache in the Wild: Characterizing and Optimizing KVCache Cache \\ at a Large Cloud Provider}}
%\author{Paper \#477}
...
\affil[1]{Institute of Parallel and Distributed Systems, Shanghai Jiao Tong University}
\affil[2]{Alibaba Group\vspace{-1.mm}}

\iffalse
\setlength{\affilsep}{0.5em}
\author[1,2]{Xingda Wei}
\author[1,2]{Rongxin Cheng}
\author[1]{Yuhan Yang}
\author[1,2]{Rong Chen}%\thanks{Rong Chen is the corresponding author (\url{rongchen@sjtu.edu.cn})}}
\author[1] {Haibo Chen}
%\vspace*{-30pt}
\affil[1]{\vspace{-2.mm}Institute of Parallel and Distributed Systems, SEIEE, Shanghai Jiao Tong University\vspace{0.8mm}}
\affil[2]{Shanghai AI Laboratory\vspace{-1.mm}}
\fi
