...
\begin{wraptable}{r}{0.5\linewidth}
    ...
    \caption{Terminal-Bench 2 全部 89 个任务上按官方难度划分的 pass@1。NexAU\textsubscript{0} 是共享的种子；ACE、Training-Free GRPO 与 \textbf{AHE} 是叠加在其之上的三种自演化闭环。粗体标出每列最优；并列时全部加粗。}
    \label{tab:main-results}
    \begin{tabular}{lcccc}
        \toprule
        方法 & 全部 & 简单 & 中等 & 困难 \\
               & {\scriptsize 89} & {\scriptsize 4} & {\scriptsize 55} & {\scriptsize 30} \\
        \midrule
        \rowcolor{gray!20} \multicolumn{5}{l}{\textbf{人工设计的 harness}} \\
        OpenCode               & 47.2\% & 75.0\% & 52.7\% & 33.3\% \\
        Terminus-2             & 62.9\% & 75.0\% & 74.5\% & 40.0\% \\
        Codex              & 71.9\% & 75.0\% & 80.0\% & \textbf{56.7\%} \\
        \addlinespace
        \rowcolor{gray!20} \multicolumn{5}{l}{\textbf{从 NexAU\textsubscript{0} 自演化}} \\
        NexAU\textsubscript{0} & 69.7\% & 87.5\% & 78.2\% & 51.7\% \\
        ACE                    & 68.9\% & 91.7\% & 78.2\% & 48.9\% \\
        TF-GRPO                & 72.3\% & \textbf{100.0\%} & 79.4\% & 55.6\% \\
        \textbf{AHE}           & \textbf{77.0\%} & \textbf{100.0\%} & \textbf{88.2\%} & 53.3\% \\
