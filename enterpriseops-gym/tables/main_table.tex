...
\toprule
\textbf{Model} & \textbf{Teams} & \textbf{CSM} & \textbf{Email} & \textbf{ITSM} & \textbf{Calendar} & \textbf{HR} & \textbf{Drive} & \textbf{Hybrid} & \textbf{Infeas.} & \textbf{Avg.}\\
\midrule
\rowcolor{gray!15} \multicolumn{11}{c}{\textit{Closed Source Models}} \\
...
\rowcolor{gray!15} \multicolumn{11}{c}{\textit{Open Source Models}} \\
% Nvidia Nemotron 3 S uper (Think) & 44.0 & 11.6 & \textbf{57.0} & 16.7 & 31.7 & 16.3 & 30.1 & 29.8 & 42.3 & 26.9 \\
...
\caption{Overall task completion performance on \ours{}. We report the percentage of tasks successfully completed by each model in oracle tool mode, broken down by domain. A task is considered successful only if all outcome verification checks pass.}
